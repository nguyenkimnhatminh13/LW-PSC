...
class PanopticLabelGenerator(object):
    ...
    def __call__(
        self, inst, xyz, voxel_inst, voxel_position, label_dict, min_bound, intervals
    ):
        ...
        for inst_label in inst_labels:
            ...
            if self.polar:
                ...
                center_x_pol, center_y_pol = np.sqrt(
                    center_x**2 + center_y**2
                ), np.arctan2(center_y, center_x)
            ...
            if self.polar:
                ...
                offset[0, voxel_mask[0], voxel_mask[1]] = (
                    center_x - voxel_position[0, voxel_mask[0], voxel_mask[1]]
                ) / intervals[0]
                
                offset[1, voxel_mask[0], voxel_mask[1]] = (
                    (center_y - voxel_position[1, voxel_mask[0], voxel_mask[1]] + np.pi)
                    % (2 * np.pi)
                    - np.pi
                ) / intervals[1]
            else:
                ...
                offset[1, voxel_mask[0], voxel_mask[1]] = (
                    center_y - voxel_position[1, voxel_mask[0], voxel_mask[1]]
                ) / intervals[1]
