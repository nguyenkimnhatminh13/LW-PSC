...
from .bev_net import BEVUNet, BEVUNetv1, BEVUNetvCFFE
...
class LW_PSC(nn.Module):
    ...
    def forward(self, occupancy, points, labels, aux_com):
        ...
        x_pred, center_pred, offset_pred = self.bev_model(inputs, ss_out_dict['mss_bev_dense'], sc_out_dict['mss_bev_dense'])
