...
class ResContextBlock(nn.Module):
    def __init__(
        ...
        self.conv2 = conv3x1(in_filters, out_filters, indice_key=indice_key + "bef1")
...
class ResBlock(nn.Module):
    def __init__(
        ...
        self.conv3 = conv3x1(out_filters, out_filters, indice_key=indice_key + "bef1")
        self.act3 = nn.LeakyReLU()
        self.bn2 = nn.BatchNorm1d(out_filters)
...
class UpBlock(nn.Module):
    def __init__(
        ...
        self.up_subm = spconv.SparseInverseConv3d(
            out_filters, out_filters, kernel_size=3, indice_key=up_key, bias=False
        )
...
class Asymm_3d_spconv(nn.Module):
    def __init__(
        ...
        self.nheight = input_dimensions[2]
        self.strict = False
        ...
        self.upBlock0 = UpBlock(
            16 * init_size, 16 * init_size, indice_key="up0", up_key="down5"
        )
